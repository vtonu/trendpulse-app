...
const seeds: ArtistSeed[] = [
  ...
  { id: "cosplatt", name: "cosplatt", change24h: 18, change7d: 33, change30d: 51, change90d: 74, demand: 71, competition: 32, momentum: 90, status: "rising fast", genres: ["dark trap", "sample trap"], isCredit: false, isPriority: true },
